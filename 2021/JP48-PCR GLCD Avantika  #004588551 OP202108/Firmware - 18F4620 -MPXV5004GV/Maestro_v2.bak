...
char  Vida_Filtro[] = "Filtro:",ZFP[] = "Fabrica:240.0", Perdida[]="!Filtro Saturado!", Tempo[]="Tempo UV:",Vida_UV[] = "UVLife:";
      ...
      if(Menu==2){ //Menu General.
         ...
         if(imprimir==1){
            ...
            if(Filtro_Downflow>=0.9){
               ...
               strcpy(Menus.Letra,"JPCV36-PCR-EC");
...
// Fin de Dibujo de barra de estado de Filtro
         ...
         if(tvidrio>=30){//Si se activa switch magnetico de vidrio
           flag_blower=0;
           flag_luz=0;
         }else{
           flag_uv=0; 
      ...
      if(tleft>=30){//Si oprime boton de UV.
         if(Flanco4 == 0){
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------
      ...
      if(RIGHT){//Si oprime SET
         if(Flanco1 == 0){
            Flanco1 = 1;delay_ms(50);Menu=Opcion+3;Opcion=1;glcd_fillscreen(OFF);unidad=1;
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------
      ...
      if(RIGHT)//Si oprime SET
      {  if(Flanco1 == 0) 
            {Flanco1 = 1;delay_ms(50);Menu=Opcion+10;glcd_fillScreen(OFF);
            }
      }
         else
            {Flanco1 = 0;}  
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------
      ...
      if(RIGHT)//Si oprime SET
      {  if(Flanco1 == 0) 
            {Flanco1 = 1;delay_ms(50);Menu=Opcion+30;glcd_fillScreen(OFF);Opcion=1;unidad=1;
            }
      }
         else
            {Flanco1 = 0;}  
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------
      ...
      if(LEFT)//Si oprime boton de Toma.
      {
         delay_ms(70);Menu=4;glcd_fillscreen(OFF);Opcion=1;unidad=1;
